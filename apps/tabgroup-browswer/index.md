...
layout: app
title: 쓸만한 탭그룹 브라우저
privacy_url: /apps/tabgroup-browswer/privacy
---
...
## 📘 약관 및 정책
- 아래 내용은 **쓸만한 탭그룹 브라우저** 이용 시 적용되는 기본 정책입니다.
...
- 외부 링크, 외부 앱 실행, 백업 데이터의 보관 및 전달 과정에서 발생하는 문제에 대해서는 사용자가 직접 주의하고 관리해야 합니다.
- 앱 운영자는 권리 침해나 오남용이 의심되는 사용 행위에 대해 관련 기능 이용을 제한할 수 있습니다.
...
["쓸만한 탭그룹 브라우저" 개인정보처리방침](/apps/tabgroup-browswer/privacy)

## 🧑‍💻 개발자 소개

{% include shared-developer.md %}

# 🇺🇸 Solid TabGroup Browser
...
## 📘 Terms & Policies
- The following policies apply when using **Solid TabGroup Browser**.
...
- Users should take care when handling external links, external app launches, and the storage or transfer of backup data.
- The app operator may restrict access to related features if misuse or rights-related issues are reasonably suspected.
...
["Solid TabGroup Browser" Privacy Policy](/apps/tabgroup-browswer/privacy)
